      ...
      <AnimatePresence mode="wait">
        {isSuccess ? (
          ...
          >
            ...
            <h4 className="text-3xl font-serif text-foreground mb-4">You&apos;re All Set</h4>
            ...
            {downloadUrl && (
              ...
              >
                <Button type="button" size="lg" className="text-base tracking-widest shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 gap-2">
          ...
          >
            ...
            <div className="pt-8">
              <Button type="submit" size="lg" className="w-full text-base tracking-widest shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1" disabled={isSubmitting}>
                {isSubmitting ? 'SECURELY SENDING...' : ctaLabel.toUpperCase()}
              </Button>
            </div>
